(define skk-on-key '("<IgnoreShift><Control>;"))
(define skk-on-key? (make-key-predicate '("<IgnoreShift><Control>;")))
(define skk-latin-key '("<IgnoreCase>l" "zenkaku-hankaku" "<Shift> "))
(define skk-latin-key? (make-key-predicate '("<IgnoreCase>l" "zenkaku-hankaku" "<Shift> ")))
...
(define skk-sticky-key '("<IgnoreShift>;"))
(define skk-sticky-key? (make-key-predicate '("<IgnoreShift>;")))
