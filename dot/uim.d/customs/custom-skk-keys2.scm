...
(define skk-vi-escape-key '("escape" "<IgnoreShift><Control>[" "<IgnoreCase><Control>c"))
(define skk-vi-escape-key? (make-key-predicate '("escape" "<IgnoreShift><Control>[" "<IgnoreCase><Control>c")))
